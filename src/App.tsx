...
import SWPCalculator               from './calculators/investments/SWP'
import RetirementPlannerCalculator from './calculators/investments/RetirementPlanner'
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'swp',                 element: <SWPCalculator /> },
          { path: 'retirement-planner',  element: <RetirementPlannerCalculator /> },
        ],
      },
